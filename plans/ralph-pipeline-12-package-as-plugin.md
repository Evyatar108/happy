...
- **Remove** the extracted files:
  - `scripts/lib/derive-ralph-stage.mjs`, `scripts/lib/derive-next-command.mjs`, `scripts/lib/sync-core.mjs`, `scripts/lib/watch-ralph-state.mjs`, `scripts/lib/score-recommendations.mjs`, `scripts/lib/derive-dependency-graph.mjs`, `scripts/lib/parse-notepad.mjs`, `scripts/lib/derive-pr-links.mjs`, `scripts/lib/append-journal.mjs`, `scripts/lib/emit-snapshot.mjs`, `scripts/lib/emit-activity.mjs`, `scripts/lib/emit-tasks-index.mjs`, `scripts/lib/emit-snapshot-schema.mjs`, `scripts/lib/crews-cross-walk.mjs`, `scripts/lib/parse-spawn-launcher.mjs`, `scripts/lib/resolve-config.mjs`, `scripts/lib/default-config.mjs`.
