...
export type DevTunnelsClientProviderOptions = {
    ...
    apiBaseUrl?: string;
    httpClient?: Pick<AxiosInstance, 'get' | 'delete'>;
...
export class DevTunnelsClientProvider implements ClientTunnelProvider {
    ...
    private readonly httpClient: Pick<AxiosInstance, 'get' | 'delete'>;
    ...
    async getConnectToken(tunnelId: string): Promise<string> {
        ...
        const data = response.data as { accessTokens?: { connect?: unknown }; accessToken?: unknown };
