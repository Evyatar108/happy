        ...
        try {
            ...
            switch (result.type) {
                case 'success':
                    ...
                    // If sendMessage rejects (throws), the outer catch handles it and
                    // composer state (prompt + attachments) stays staged for retry.
                    ...
                    // Clear input text only after sendMessage succeeds (preserves
                    // text+attachments symmetry on rejection).
                    setPrompt('');
