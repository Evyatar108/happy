...
const mockUseSession = vi.fn<(id: string) => { metadata?: { skills?: string[] } | null } | null>();
...
const { SkillsScreen, EMPTY_STATE_TITLE } = await import('./skills');
...
describe('SkillsScreen', () => {
    ...
    it('renders the empty state when the session has no skills metadata', () => {
        mockUseSession.mockReturnValue({
            metadata: {},
        });
