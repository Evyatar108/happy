...
// Opt out of the global `vi.mock('@/hooks/useNewSessionAttachments', ...)` from
// `_test-stubs/setup.ts` — this spec exercises the real zustand store.
vi.unmock('@/hooks/useNewSessionAttachments');
