export const SNAPSHOT_SCHEMA = {
    ...
    $defs: {
        ...
        CrewSessionRef: {
            type: 'object',
            additionalProperties: false,
            required: ['crewName', 'memberName', 'startedAt'],
            properties: {
        ...
        CrewSessionsByStage: {
            ...
            additionalProperties: false,
            properties: {
                'brainstorming': { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                'brainstorm-ready': { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                planning: { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                'plan-ready': { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                implementing: { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                reviewing: { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                'review-fix': { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                'replan-pending': { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                shipped: { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
                blocked: { type: 'array', items: { $ref: '#/$defs/CrewSessionRef' } },
            },
        },
        RalphPipelineState: {
            type: 'object',
            ...
            properties: {
                ...
                deferredQuestionsCount: { type: 'number' },
                deferredQuestionsPreview: { type: 'string' },
                mergeCommit: { type: 'string' },
                prUrl: { type: 'string' },
                storyDoctorInterventions: { type: 'number' },
                ...
                crewSessions: { $ref: '#/$defs/CrewSessionsByStage' },
            },
        },
        SnapshotTask: {
            allOf: [
